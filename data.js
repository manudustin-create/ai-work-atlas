var DATA = [
    ...
    {id:"LIT",name:"HR as Cosmetic Trainer",family:"Augment",layer:"HR",x:0,overlays:["G"],definition:"Dall'uso del tool al redesign del lavoro: HR trasforma l'adozione in pratica verificabile. Il drift è ridurre tutto a training — uso senza riprogettazione e senza verifiche di impatto.",signals:["Formazione come checkbox","Adozione misurata in accessi, non in pratica","Nessun redesign dei processi"],failure:"HR as Adoption Trainer: formazione cosmetica, uso senza riprogettazione.",guardrail:"Fluency come standard: ruoli ridisegnati, escalation chiare, evidenze di impatto.",sources:["Floridi","Choudary"],editorial:"<p>In molte organizzazioni la formazione sull'intelligenza artificiale coincide ancora con la sua versione più visibile e rassicurante: corsi di prompting, manuali d'uso, tutorial sui tool di AI generativa, percorsi di adoption scanditi da metriche, badge e dashboard. È una formazione pulita, ordinata, facilmente raccontabile. Mostra persone davanti a schermi luminosi, workshop aziendali, linguaggi di innovazione, velocità, efficienza, aggiornamento. Tutto sembra indicare che la trasformazione sia in corso e che la funzione HR abbia assolto il proprio compito: portare i tool in azienda, insegnarne l'uso, favorirne la diffusione.</p><p>Tuttavia questa scena mostra solo la superficie del problema. L'AI literacy tecnica è una soglia necessaria che non esaurisce ciò che davvero è in gioco. Saper interrogare un sistema non significa comprenderne i limiti così come saper scrivere prompt efficaci non coincide con la capacità di giudicare la qualità del sapere prodotto. Allo stesso modo familiarizzare con l'interfaccia non equivale a cogliere gli effetti cognitivi, etici e organizzativi che essa introduce. La persona può apparire più rapida, più fluida, più potenziata, e tuttavia diventare più dipendente da logiche che non controlla pienamente, più esposta a forme silenziose di standardizzazione del pensiero, più incline a delegare non solo attività, ma porzioni di discernimento.</p><p>La vera frattura non separa chi usa l'AI da chi non la usa ma distingue una formazione che abilita tecnicamente da una formazione che rende realmente consapevoli. Da un lato vi è lo spazio luminoso dell'adozione: aule corporate, schermi, interfacce, indicatori di completamento, lessico della produttività. Dall'altro vi sono le zone meno illuminate, spesso trascurate: il pensiero critico, la contestualizzazione, la capacità di sospendere l'automatismo, l'interrogazione dei bias, la comprensione delle implicazioni sul lavoro, sul sapere, sulla responsabilità. È qui che emerge l'insufficienza della sola alfabetizzazione tecnica: essa insegna a usare lo strumento, ma non necessariamente a comprendere il mondo che lo strumento contribuisce a plasmare.</p><p>La funzione HR si trova così al centro di un equivoco tipico del presente. Quando considera compiuta la propria missione formativa per il solo fatto di aver introdotto corsi sui tool, percorsi di prompting e piani di adoption, rischia di ridurre una trasformazione ben più profonda a un addestramento operativo. Ma educare all'AI non significa soltanto rendere le persone più competenti nell'uso delle interfacce. Significa anche coltivare giudizio, responsabilità, senso del limite, capacità di interrogare i fini oltre che i mezzi. Significa riconoscere che il nodo non è solo l'accesso alla tecnologia ma il modo in cui essa riorganizza i criteri di valore, i processi di pensiero, le forme del contributo e persino l'esperienza di sé nel lavoro.</p><p>La formazione puramente tecnica illumina la stanza principale, ma lascia ancora in ombra ciò che conta di più. Mostra l'apprendimento come acquisizione di istruzioni, ma fatica a riconoscerlo come trasformazione culturale. Insegna come usare l'intelligenza artificiale, ma non sempre apre lo spazio per comprendere che cosa l'intelligenza artificiale stia facendo al lavoro umano, alle pratiche di conoscenza, ai rapporti di potere, alle forme della decisione. È per questo che la sola AI literacy, se ridotta a tool training, resta necessaria ma insufficiente: abilita l'uso, ma non ancora la consapevolezza.</p>"},
    ...
    {id:"BEC",name:"Risk Society",family:"Extract",layer:"Society",x:1,overlays:["EX","K"],definition:"La modernizzazione produce rischi sistemici strutturalmente invisibili: distribuiti, impossibili da attribuire, scaricati sulla singola persona. Non c'è welfare, non c'è rete — solo irresponsabilità organizzata. La persona che svolge ghost work porta il rischio da sola.",signals:["Rischi distribuiti e non attribuibili","Irresponsabilità organizzata","Assenza di welfare e tutele per chi è invisibile"],failure:"Individualizzazione del rischio: il sistema produce il danno, la persona lo subisce — senza strumenti per contestare.",guardrail:"Responsabilità istituzionale, tutele collettive, visibilità dei rischi sistemici.",sources:["Beck"],editorial:"<p>In U. Beck, la modernità avanzata produce rischi \"fabbricati\", globali e difficilmente governabili, mentre la responsabilità di affrontarli viene progressivamente scaricata sugli individui. L'individualizzazione non significa solo maggiore libertà: significa anche che insicurezza, vulnerabilità e gestione del rischio vengono privatizzate, mentre le vecchie mediazioni collettive, incluse molte protezioni del welfare, si indeboliscono.</p><p>Chicchi e Simone permettono di compiere un passo ulteriore. La loro <em>società della prestazione</em> descrive un ordine sociale in cui il soggetto non si limita più a subire l'insicurezza, ma è chiamato a interiorizzarla come condizione normale della propria esistenza. Il soggetto \"responsabile\" è colui che assume su di sé l'obbligo di reggere l'incertezza, di auto-organizzarsi, di auto-valutarsi e di trasformare la precarietà in prova permanente di merito, adattabilità e valore personale. In questa prospettiva, il rischio non è più solo una minaccia esterna: diventa una grammatica interiore, una disciplina incorporata.</p><p>I <em>ghost workers</em> incarnano in modo esemplare questo passaggio. Mary L. Gray e Siddharth Suri mostrano che molti servizi apparentemente \"automatizzati\" dipendono in realtà da una forza lavoro umana dispersa, invisibile e frammentata, impegnata in micro-task, moderazione di contenuti, classificazione di dati, correzione di errori e addestramento dei modelli. L'ILO descrive queste piattaforme come ambienti di lavoro governati da <em>algorithmic management</em>: sistemi che organizzano, assegnano, monitorano, valutano e disciplinano il lavoro attraverso dati e algoritmi. Fairwork continua a documentare che, nel cloudwork globale, persistono deficit rilevanti su paga, condizioni, contratti, management e rappresentanza.</p><p>È qui che la lettura beckiana si radicalizza. I ghost workers sopportano rischi economici, temporali, psicologici e reputazionali senza godere di pieno riconoscimento sociale né di adeguate tutele istituzionali. Il rischio viene esternalizzato sulla persona, mentre il valore e la visibilità vengono concentrati sulla piattaforma, sul brand o sull'\"intelligenza\" della macchina. La promessa di autonomia maschera spesso una dipendenza strutturale: il worker è formalmente libero, ma materialmente esposto a instabilità, opacità decisionale, ricattabilità algoritmica e sostituibilità continua. La invisibilità non è un incidente; è una condizione di funzionamento dell'intero sistema.</p><p>In questo senso, i ghost workers possono essere letti come la <em>figura-limite della società della prestazione dentro la società del rischio</em>. Sono soggettività a cui viene chiesto di reggere da sole l'incertezza globale, di presentarsi come flessibili e disponibili, di sostenere infrastrutture digitali che li cancellano simbolicamente proprio mentre dipendono dal loro lavoro. Il loro paradosso è netto: rendono \"intelligente\" il sistema, ma restano socialmente invisibili; producono valore essenziale, ma vengono narrati come residuo marginale; sostengono l'automazione, ma sono la prova concreta che l'automazione non elimina il lavoro, lo redistribuisce verso forme più opache, precarie e silenziate. Anche i moderatori di contenuti studiati da Sarah T. Roberts mostrano questa logica: il retrobottega umano della piattaforma resta nascosto affinché l'interfaccia possa apparire pulita, automatica e neutrale.</p>",editorialSources:["Beck, Ulrich. <em>La società del rischio</em>.","Chicchi, Federico; Simone, Anna. <em>La società della prestazione</em>.","Gray, Mary L.; Suri, Siddharth. <em>Ghost Work</em>.","Roberts, Sarah T. <em>Behind the Screen</em>."]},
...
var COLS = [
            {k:'Occluded',t:'Occluded',s:'Extractive',desc:"Invisibilità strutturale: il lavoro esiste ma è deliberatamente nascosto, negato, frammentato. Chi lo svolge è necessario ma fuori scena — labeling, moderazione, micro-task che rendono possibile l'AI. Il rischio ricade sulla singola persona senza rete né riconoscimento. La domanda chiave: chi è invisibile, e a chi conviene che lo resti?"},
            {k:'Embedded',t:'Embedded',s:'Extractive',desc:"Invisibilità processuale: l'estrazione avviene così fluidamente da essere indistinguibile dall'uso. La persona è simultaneamente utente e trainer, consumatore e produttore — il confine tra lavoro e non-lavoro si dissolve. La domanda chiave: se non sai di lavorare, puoi contestare le condizioni?"},
